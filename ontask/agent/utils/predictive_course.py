...
from ontask.agent.canvas_api import C3L
import json
from ontask.agent.canvas_api import c3l_utils
import random as rd
import environ

class course_creator:
    def __init__(self, path):
        self.url_base  = env("CANVAS_BASE_URL" , default="")
        self.token = env("CANVAS_API_TOKEN", default="")
        self.__path__ = path
        self.c3l_obj = C3L(self.url_base, self.token)
        self.user_id = 1
            ...
            if os.path.exists(os.path.join(quiz_path, 'quizze.json')):
                ...
                if quiz_obj:
                    ...
                    if quiz_ret:
                        ...
                        print("Course id:",self.__course_id__,  "       Quiz id: ", quiz_ret['id'])
...
class agent:
    def __init__(self):
        self.canvas_url_base  = env("CANVAS_BASE_URL" , default="")
        ...
        self.c3l_obj = C3L(self.canvas_url_base, self.canvas_api_token)

        self.__base_path__ = os.path.join(
            os.path.dirname(os.path.abspath(__file__)),
            "../sample/data/PredictiveAnalysis/"
            )
        self.__course_creater__ = course_creator(self.__base_path__)

    def create_course(self):
        self.__course_creater__.create()

    def get_quizes(self):
        print(self.c3l_obj.quizzes.show(400, 383))
        #Course id: 400        Quiz id:  383
        #Course id: 400        Quiz id:  384
        #Course id: 400        Quiz id:  385
        #Course id: 400        Quiz id:  386
        pass