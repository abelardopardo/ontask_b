# Generated by Django 3.2.10 on 2023-03-31 12:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ontask', '0052_auto_20230331_2143'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='column',
            name='categories',
            field=models.JSONField(blank=True, default=list, null=True, verbose_name='comma separated list of values allowed'),
        ),
        migrations.AlterField(
            model_name='condition',
            name='_formula',
            field=models.JSONField(blank=True, default=dict, null=True, verbose_name='formula'),
        ),
        migrations.AlterField(
            model_name='filter',
            name='_formula',
