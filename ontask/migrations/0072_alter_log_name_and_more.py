...
def change_scheduled_op_type(apps, schema_editor):
    """Change the operation_type of some scheduled ops."""

    ScheduledOperation = apps.get_model('ontask', 'ScheduledOperation')
    for sitem in ScheduledOperation.objects.all():
        if sitem.operation_type == 'workflow_canvas_data_upload':
