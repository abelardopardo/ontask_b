...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='scheduledoperation',
            name='execute_start',
            field=models.DateTimeField(blank=True, null=True, verbose_name='Start of execution period'),
        ),
