...
log_types = {
    ...
    'sql_connection_create': 'SQL connection created',
    'sql_connection_edit': 'SQL connection updated',
    'sql_connection_delete': 'SQL connection deleted',
    'sql_connection_clone': 'SQL connection cloned',
