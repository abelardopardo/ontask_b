...
urlpatterns = [
    ...
    # Run ZIP action
    url(r'^(?P<pk>\d+)/zip/$', views_out.zip_action, name='zip_action'),
    ...
    url(r'^item_filter/$',
        ...
        name='item_filter'),
    url(r'^email_done/$', views_out.email_action_done, name='email_done'),
    url(r'^zip_done/$', views_out.zip_action_done, name='zip_done'),
    url(r'^zip_export/$', views_out.action_zip_export, name='zip_export'),
    url(r'^json_done/$', views_out.json_done, name='json_done'),
    url(r'^canvas_email_done/$',
