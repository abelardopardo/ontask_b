...
from action.forms_run import CanvasEmailActionForm
from action.models import Action
from action.payloads import (
    CanvasEmailPayload, action_session_dictionary, get_action_payload,
    get_action_info,
)
...
def get_oauth_info(oauth_instance_name: str) -> Mapping:
    """Get the OAuth information for the given URL."""
    # Get the information from the payload
