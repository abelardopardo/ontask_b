...
class Command(BaseCommand):
    help = """Script to create the initial database content."""
    ...
    def handle(self, *args, **options):
        ...
        if not_present:
            ...
            filenames = [x for x in options['csvfile'] if x not in not_present]
        ...
        # Get the emails
        emails = self.get_column_value_list(filenames,
                                            options['email'],
                                            options['verbosity'] > 0)
