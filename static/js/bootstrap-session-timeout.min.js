...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        ...
        if (typeof opt.onWarn !== 'function') {
            // If opt.countdownMessage is defined add a countdown timer message to the modal dialog
            var countdownMessage = opt.countdownMessage ?
                '<p>' + opt.countdownMessage.replace(/{timer}/g, '<span class="countdown-holder"></span>') + '</p>' : '';
            var coundownBarHtml = opt.countdownBar ?
                '<div class="progress"> \
                  <div class="progress-bar bg-striped countdown-bar progress-bar-animated" role="progressbar" style="min-width: 15px; width: 100%;"> \
              ...
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                  ...
                  <div class="modal-footer"> \
                    <button id="session-timeout-dialog-logout" type="button" class="shadow btn btn-outline-dark">' + opt.logoutButton + '</button> \
                    <button id="session-timeout-dialog-keepalive" type="button" class="shadow btn btn-outline-primary" data-bs-dismiss="modal">' + opt.keepAliveButton + '</button> \
                  </div> \
                </div> \
              </div> \
             </div>');
